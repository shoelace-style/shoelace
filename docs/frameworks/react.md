...
?> If you'd rather not use the CDN for assets, you can create a [build task](https://webpack.js.org/plugins/copy-webpack-plugin/) that copies `node_modules/@teamshares/shoelace/dist/assets` into your app's `public` directory. Then you can point the base path to that folder instead.
...
import { useState } from 'react';
import { SlInput } from '@teamshares/shoelace/dist/react';
import type SlInputElement from '@teamshares/shoelace/dist/components/input/input';
