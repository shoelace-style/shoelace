...
<script type="module">
  import { setBasePath } from '@teamshares/shoelace/%NPMDIR%/utilities/base-path.js';
...
```html
<script type="module">
  import { getBasePath, setBasePath } from '@teamshares/shoelace/%NPMDIR%/utilities/base-path.js';
...
<script type="module" data-shoelace="/path/to/shoelace/%NPMDIR%">
  import '@teamshares/shoelace/%NPMDIR%/components/button/button.js';
...
import '@teamshares/shoelace/%NPMDIR%/components/button/button.js';
import '@teamshares/shoelace/%NPMDIR%/components/icon/icon.js';
import '@teamshares/shoelace/%NPMDIR%/components/input/input.js';
import '@teamshares/shoelace/%NPMDIR%/components/rating/rating.js';
import { setBasePath } from '@teamshares/shoelace/%NPMDIR%/utilities/base-path.js';
...
```diff
- import SlButton from '@teamshares/shoelace/%NPMDIR%/components/button/button.js';
+ import SlButton from '@teamshares/shoelace/%NPMDIR%/components/button/button.component.js';
```
...
- `@teamshares/shoelace/%CDNDIR%` is for CDN users
- `@teamshares/shoelace/%NPMDIR%` is for npm users
