...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@teamshares/shoelace?path=dist%2Ftranslations)
- If you're using a bundler, import them from `@teamshares/shoelace/dist/translations/[lang].js`
...
```js
import { registerTranslation } from '@teamshares/shoelace/dist/utilities/localize';
import type { Translation } from '@teamshares/shoelace/dist/utilities/localize';
