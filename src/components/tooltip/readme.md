...
| `placement`    | `placement`     | The preferred placement of the tooltip. Note that the actual placement may vary as needed to keep the tooltip inside of the viewport.                                                                                                                                                                                                | `"bottom" or "bottom-end" or "bottom-start" or "left" or "left-end" or "left-start" or "right" or "right-end" or "right-start" or "top" or "top-end" or "top-start"` | `'top'`              |
