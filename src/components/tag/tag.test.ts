...
describe('<sl-tag>', () => {
  it('should render default tag', async () => {
    ...
    expect(base.getAttribute('class')).to.equal(' tag ');
  });
  ...
  it('should set variant by attribute', async () => {
    ...
    expect(base.getAttribute('class')).to.equal(' tag tag--danger ');
  });
  ...
  it('should set pill-attribute by attribute', async () => {
    ...
    expect(base.getAttribute('class')).to.equal(' tag tag--pill ');
  });
  ...
  it('should set removable by attribute', async () => {
    ...
    expect(base.getAttribute('class')).to.equal(' tag tag--removable ');
