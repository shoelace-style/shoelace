...
| ---------------- | ---------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------ |
| `_inputMode`     | `inputmode`      | The input's inputmode attribute.                           | `"decimal" \| "email" \| "none" \| "numeric" \| "search" \| "tel" \| "text" \| "url"` | `undefined`  |
| `_tabIndex`      | `tabindex`       | The input's tabindex attribute.                            | `number`                                                                              | `undefined`  |
...
| `size`           | `size`           | The textarea's size, one of `small`, `medium`, or `large`. | `string`                                                                              | `'medium'`   |
